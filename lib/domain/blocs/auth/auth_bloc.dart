...
import 'package:reporting_system/data/repos/authentication/base_authentication_repository.dart';
...
class AuthBloc extends Bloc<AuthEvent, AuthState> {
  ...
  FutureOr<void> _onEmailPasswordSignInEvent(EmailPasswordSignInEvent event, Emitter<AuthState> emit) async{
            try {
      emit(LoadingAuthState());
